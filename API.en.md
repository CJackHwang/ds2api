...
- `tool_calls` shown inside fenced markdown code blocks (for example, ```json ... ```) or inline code spans are treated as examples, not executable calls.
