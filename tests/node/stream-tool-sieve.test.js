...
test('sieve still intercepts tool json when leading prose exists (strict mode)', () => {
  const events = runSieve(
...
test('sieve intercepts same-chunk payload and drops trailing prose in strict mode', () => {
  const events = runSieve(
